...
/**
 ...
 replace} Elements in the list will also act on the underlying {@link io.kapaseker.kharcho.nodes.Document DOM}.</p>
...
public class Elements extends Nodes<Element> {
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link io.kapaseker.kharcho.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     * @see #clear()
