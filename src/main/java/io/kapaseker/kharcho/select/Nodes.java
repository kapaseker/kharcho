...
/**
 ...
 {@link io.kapaseker.kharcho.nodes.Document DOM}.</p>
...
public class Nodes<T extends Node> extends ArrayList<T> {
    ...
    /**
     ...
     <p>
     Note that this method should not be used to clean user-submitted HTML; rather, use {@link io.kapaseker.kharcho.safety.Cleaner}
     to clean HTML.
