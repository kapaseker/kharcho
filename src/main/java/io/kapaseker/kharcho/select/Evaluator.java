...
import io.kapaseker.kharcho.nodes.PseudoTextElement;
...
import static io.kapaseker.kharcho.internal.Normalizer.lowerCase;
import static io.kapaseker.kharcho.internal.Normalizer.normalize;
import static io.kapaseker.kharcho.internal.StringUtil.normaliseWhitespace;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<io.kapaseker.kharcho.nodes.Attribute> values = element.attributes().asList();
            for (io.kapaseker.kharcho.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                    io.kapaseker.kharcho.parser.Tag.valueOf(element.tagName(), element.tag().namespace(), ParseSettings.preserveCase), element.baseUri(), element.attributes());
