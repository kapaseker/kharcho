...
import static io.kapaseker.kharcho.internal.StringUtil.inSorted;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilder.isSpecial;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.AfterHeadBody;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.BeforeHtmlToHead;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InBodyEndOtherErrors;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InBodyStartToHead;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InCaptionIgnore;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InCellCol;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InCellNames;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InForeignToHtml;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InHeadEmpty;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InHeadNoScriptHead;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InHeadNoscriptIgnore;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InHeadRaw;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InRowIgnore;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InRowMissing;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InSelectEnd;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InSelectTableEnd;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableAddBody;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableBodyEndIgnore;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableBodyExit;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableEndErr;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableEndIgnore;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableFoster;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableToBody;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTableToHead;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTemplateToHead;
import static io.kapaseker.kharcho.parser.HtmlTreeBuilderState.Constants.InTemplateToTable;
