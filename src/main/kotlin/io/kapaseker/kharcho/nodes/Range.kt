 ...
 * [io.kapaseker.kharcho.parser.Parser.setTrackPosition].
 ...
 */(private val start: Position, private val end: Position) {
     ...
     */(private val pos: Int, private val lineNumber: Int, private val columnNumber: Int) {
         ...
         */
        override fun toString(): String {
            return lineNumber.toString() + "," + columnNumber + ":" + pos
        }
    ...
    /** Creates a new AttributeRange. Called during parsing by Token.StartTag.  */(
        ...
        override fun equals(o: Any?): Boolean {
            ...
            val that = o as AttributeRange

            if (nameRange != that.nameRange) return false
        ...
        companion object {
            val UntrackedAttr: AttributeRange = AttributeRange(Untracked, Untracked)
        }
    }
    ...
    companion object {
        ...
        val Untracked: Range = Range(UntrackedPos, UntrackedPos)
        ...
        fun of(node: Node, start: Boolean): Range? {
            val key: String = if (start) RangeKey else EndRangeKey
